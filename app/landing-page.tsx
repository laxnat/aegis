        ...
        <div key={i} className="flex items-center gap-3 px-4 py-3 border-b border-white/5 last:border-0">
          ...
          {item.pinned ? (
            ...
            <motion.span
              ...
              transition={{ duration: 0.35, delay: isHovered ? i * 0.25 : 0, ease: 'backOut' }}
              className="text-highlight text-sm shrink-0"
            >★</motion.span>
          )}
        </div>
...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-secondary text-white flex flex-col">
      ...
      {/* ── Hero ── */}
      <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-8 pt-16 pb-24 overflow-hidden min-h-screen">
        ...
        >
          ...
          {/* Title */}
          <h1 className="font-display text-[4.5rem] sm:text-[8rem] lg:text-[11rem] leading-none text-white mb-2">
            AEGIS
          </h1>
